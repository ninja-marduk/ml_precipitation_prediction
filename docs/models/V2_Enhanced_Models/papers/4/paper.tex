...
\subfloat[RMSE by model, PAFC ($H=12$).]{\includegraphics[width=0.48\textwidth]{figures/h12/rmse_by_model_h12_pafc.png}}\hfill
...
\subfloat[$\Delta$RMSE (H12--H6), per model \& experiment.]{\includegraphics[width=0.48\textwidth]{figures/h12/rmse_delta_h12_vs_h6.png}}\hfill
\subfloat[$\Delta R^{2}$ (H12--H6), per model \& experiment.]{\includegraphics[width=0.48\textwidth]{figures/h12/r2_delta_h12_vs_h6.png}}\\[10pt]
...
\begin{figure}[H]
\centering
\subfloat[Best validation loss ($H=6$).]{\includegraphics[width=0.8\textwidth]{figures/h6/best_val_loss_matrix.png}}\\[12pt]
\subfloat[Best validation loss ($H=12$).]{\includegraphics[width=0.8\textwidth]{figures/h12/best_val_loss_matrix.png}}
