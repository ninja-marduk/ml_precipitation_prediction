...
\newcommand{\orcidauthorB}{0000-0002-3506-3787}
\newcommand{\orcidauthorC}{0000-0003-1656-4452}
\newcommand{\orcidauthorD}{0000-0002-7396-8915}

\Author{Manuel Ricardo P\'erez Reyes $^{1,3}$\orcidA{}, Jos\'e Antonio Reyes Su\'arez $^{2}$\orcidB{}, Marco Javier Su\'arez Bar\'on $^{3}$\orcidC{} and \'Oscar Javier Garc\'ia Cabrejo $^{4}$\orcidD{}}
\AuthorNames{Manuel Ricardo P\'erez Reyes, Jos\'e Antonio Reyes Su\'arez, Marco Javier Su\'arez Bar\'on and \'Oscar Javier Garc\'ia Cabrejo}
\AuthorCitation{P\'erez Reyes, M.R.; Reyes Su\'arez, J.A.; Su\'arez Bar\'on, M.J.; Garc\'ia Cabrejo, \'O.J.}
\address{%
$^{1}$ \quad Pedagogical and Technological University of Colombia (UPTC), School of Systems Engineering, Sogamoso 152210, Colombia\\
$^{2}$ \quad Department of Bioinformatics, Faculty of Engineering, University of Talca, Talca 34600000, Chile\\
$^{3}$ \quad Pedagogical and Technological University of Colombia (UPTC), School of Systems Engineering, Sogamoso 152210, Colombia\\
$^{4}$ \quad Pedagogical and Technological University of Colombia (UPTC), School of Geology, Sogamoso 152210, Colombia}
\corres{Correspondence: manuelricardo.perez@uptc.edu.co}

%------------------------------------------------------------------
% Header and footer customization (Hydrology style)
\setlength{\headheight}{20pt}
\fancyhead[L]{\includegraphics[height=12pt]{figures/hydrology-logo-print.png}}
\fancyhead[C]{}
...
\begin{figure}[H]
\centering
\subfloat[Evolution $H=6$.]{\includegraphics[width=0.48\textwidth]{figures/metrics_evolution_by_horizon_h6.png}}\hfill
\subfloat[Normalized $H=6$.]{\includegraphics[width=0.48\textwidth]{figures/normalized_metrics_comparison_h6.png}}\\[10pt]
\subfloat[RMSE $H=6$.]{\includegraphics[width=0.48\textwidth]{figures/h6/rmse_by_model_experiment.png}}\hfill
\subfloat[$R^{2}$ $H=6$.]{\includegraphics[width=0.48\textwidth]{figures/h6/r2_by_model_experiment.png}}
\caption{Training and per-model comparisons for $H{=}6$. BASIC converges fastest; KCE trims bias; PAFC improves RMSE but loses explanatory power.}
\label{fig:exp-h6}
\end{figure}

\begin{figure}[H]
\centering
\subfloat[Evolution $H=12$.]{\includegraphics[width=0.48\textwidth]{figures/metrics_evolution_by_horizon_h12.png}}\hfill
\subfloat[Normalized $H=12$.]{\includegraphics[width=0.48\textwidth]{figures/normalized_metrics_comparison_h12.png}}\\[10pt]
\subfloat[RMSE $H=12$.]{\includegraphics[width=0.48\textwidth]{figures/h12/rmse_by_model_experiment.png}}\hfill
\subfloat[$R^{2}$ $H=12$.]{\includegraphics[width=0.48\textwidth]{figures/h12/r2_by_model_experiment.png}}
\caption{Training and per-model comparisons for $H{=}12$. BASIC remains balanced; KCE trims bias; PAFC gains RMSE at the cost of explanatory power.}
\label{fig:exp-h12}
\end{figure}
...
\begin{figure}[H]
\centering
\subfloat[Bias by model ($H=6$).]{\includegraphics[width=0.49\textwidth]{figures/h6/bias_by_model_experiment.png}}\hfill
\subfloat[Bias by model ($H=12$).]{\includegraphics[width=0.49\textwidth]{figures/h12/bias_by_model_experiment.png}}\\[6pt]
\subfloat[$\Delta$RMSE (12--6).]{\includegraphics[width=0.49\textwidth]{figures/h12/rmse_delta_h12_vs_h6.png}}\hfill
\subfloat[$\Delta R^{2}$ (12--6).]{\includegraphics[width=0.49\textwidth]{figures/h12/r2_delta_h12_vs_h6.png}}
\caption{Bias and horizon impacts. Top: systematic biases per architecture (negative bars underestimation, positive overestimation); KCE narrows spread, BASIC centers near zero at $H{=}12$, PAFC underestimates more for long horizons. Bottom: extending the horizon to 12 months: green/yellow bars denote improvements; red denotes degradation. BASIC degrades least in RMSE and retains positive $R^{2}$; KCE gains some $R^{2}$ at mid-horizons; PAFC shows mixed changes with larger variance.}
\label{fig:deltas}
\end{figure}
...
\begin{figure}[H]
\centering
\subfloat[Best validation loss ($H=6$).]{\includegraphics[width=0.49\textwidth]{figures/h6/best_val_loss_matrix.png}}\hfill
\subfloat[Best validation loss ($H=12$).]{\includegraphics[width=0.49\textwidth]{figures/h12/best_val_loss_matrix.png}}
\caption{Convergence behaviour by architecture and experiment. Cooler colors indicate lower loss. BASIC and KCE achieve the lowest validation loss at $H{=}6$; at $H{=}12$ only a subset of KCE/PAFC models remain competitive, underscoring the need for stronger regularization when adding lags and attention.}
\label{fig:valloss}
\end{figure}
