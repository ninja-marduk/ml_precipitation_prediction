...
def main():
    ...
    try:
        ...
        # Define the output .nc file path
        output_nc_path = "/Users/riperez/Conda/anaconda3/doc/precipitation/output/boyaca_region_monthly_aggregated.nc"

        # Define the script to run if the .nc file does not exist
        aggregation_script = "/Users/riperez/Conda/anaconda3/envs/precipitation_prediction/github.com/ml_precipitation_prediction/data/transformation/aggregation/chirps-2.0-monthly-coordinates-aggregation-avg.py"

        # Check if the .nc file exists
        if not os.path.exists(output_nc_path):
            logging.info(f"Output file {output_nc_path} not found. Running aggregation script...")
            run_script(aggregation_script)
        else:
            logging.info(f"Output file {output_nc_path} already exists. Skipping aggregation script.")

        # Additional scripts can be added here if needed
        scripts = [
            "/Users/riperez/Conda/anaconda3/envs/precipitation_prediction/github.com/ml_precipitation_prediction/data/transformation/merge/chirps-2.0-monthly-with-dem-in-standard-resolution.py",
            "/Users/riperez/Conda/anaconda3/envs/precipitation_prediction/github.com/ml_precipitation_prediction/data/transformation/correlation/chirps-2.0-monthly-coordinates-aggregation-and-elevation.py"
        ]
