...
def main():
    """
    Main function to execute the Correlation process.
    """
    try:
        logging.info("Starting Correlation process...")

        # Define the script to run
        script = "/Users/riperez/Conda/anaconda3/envs/precipitation_prediction/github.com/ml_precipitation_prediction/data/transformation/correlation/chirps_2.0_months_coordinates_aggregation_avg_and_elevation.py"

        # Execute the script
        run_script(script)

        logging.info("Correlation process completed successfully!")
    except Exception as e:
        logging.error(f"An unexpected error occurred in the Correlation process: {e}")
        sys.exit(1)
