...
def aggregate_monthly_coordinates_precipitation(ds):
    ...
    """
    try:
        logging.info("Aggregating precipitation data by month and coordinates...")
...
def main():
    ...
    try:
        ...
        logging.info("Aggregating Boyacá data by month and coordinates...")
        monthly_boyaca = aggregate_monthly_coordinates_precipitation(combined_ds)
        logging.info("Boyacá monthly and coordinates aggregation completed!")

        logging.info("Saving processed data to NetCDF files...")
        ...
        logging.info("Data saved to NetCDF files.")
    except Exception as e:
