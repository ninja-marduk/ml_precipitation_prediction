...
def main():
    ...
    try:
        ...
        scripts = [
            "/Users/riperez/Conda/anaconda3/envs/precipitation_prediction/github.com/ml_precipitation_prediction/data/transformation/aggregation/chirps_2.0_monthly_coordinates_sum.py",
            "/Users/riperez/Conda/anaconda3/envs/precipitation_prediction/github.com/ml_precipitation_prediction/data/transformation/aggregation/chirps-2.0_months_coordinates_aggregation_avg.py"
        ]
        ...
        logging.error(f"An unexpected error occurred in the Transformation process: {e}")
        sys.exit(1)
