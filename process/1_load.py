...
def main():
    ...
    try:
        ...
        scripts = [
            "/Users/riperez/Conda/anaconda3/envs/precipitation_prediction/github.com/ml_precipitation_prediction/data/load/chirps-2.0_daily.py",
            "/Users/riperez/Conda/anaconda3/envs/precipitation_prediction/github.com/ml_precipitation_prediction/data/load/dem90m.py"
        ]
        ...
        logging.error(f"An unexpected error occurred in the Load process: {e}")
        sys.exit(1)
