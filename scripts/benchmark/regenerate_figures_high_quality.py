...
# ============================================================================
FIGURE_DPI = 800  # Q1 journal standard (thesis quality)
FIGURE_FORMAT = 'png'
FONT_SIZE = 12
TITLE_SIZE = 14
LABEL_SIZE = 12
...
COLORS = {
    ...
    'V2': '#0072B2',     # Blue (Okabe-Ito) - ConvLSTM
    'V3': '#F0E442',     # Yellow (Okabe-Ito) - FNO
    'V4': '#E69F00',     # Orange (Okabe-Ito) - GNN-TAT
}
...
def plot_bias_by_model(metrics_df, output_dir, horizon='h12'):
    ...
    for exp in ['BASIC', 'KCE', 'PAFC']:
        ...
        colors = [COLORS.get(exp) if v >= 0 else '#D55E00' for v in model_bias.values]
