...
def main():
    ...
    try:
        ...
        script = "/Users/riperez/Conda/anaconda3/envs/precipitation_prediction/github.com/ml_precipitation_prediction/data/transformation/merge/chirps-2.0-monthly-with-dem-in-standard-resolution.py"
        ...
        logging.error(f"An unexpected error occurred in the Merge process: {e}")
        sys.exit(1)
