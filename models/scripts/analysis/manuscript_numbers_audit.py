...
ANCHORS = [
    ...
    A("ridge.wconv", "ridge.mean.wconv",
      r"efit\s+are\s+\$w_\{\\mathrm\{ConvLSTM\}\}\s+=\s+(\d+\.\d+)"),
    A("ridge.wgnn", "ridge.mean.wgnn",
      r"pm\s+0\.213\$\s+and\s+\$w_\{\\mathrm\{GNN\}\}\s+=\s+(\d+\.\d+)"),
